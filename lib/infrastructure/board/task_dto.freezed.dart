...
class _$TaskDtoImpl extends _TaskDto {
  ...
  @override
  String toString() {
    return 'TaskDto(id: $id, title: $title, description: $description, status: $status, intervals: $intervals, completedAt: $completedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, status,
      const DeepCollectionEquality().hash(_intervals), completedAt);
...
abstract class _TaskDto extends TaskDto {
  factory _TaskDto(
      ...
      final List<DateTime>? intervals,
      final DateTime? completedAt}) = _$TaskDtoImpl;
  _TaskDto._() : super._();
